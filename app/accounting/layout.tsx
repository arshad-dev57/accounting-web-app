...
function AccountingSidebar() {
  ...
  // Permission mapping for accounting sub-pages
  const accountingPages = [
    ...
    { path: '/accounting/payments', label: 'Payments', permission: 'payments' },
    ...
    { path: '/accounting/revenue', label: 'Revenue', permission: 'revenue' },
  ...
  const reportPages = [
    ...
    { path: '/accounting/reports/profit-loss', label: 'Profit & Loss', permission: 'profit-loss' },
    { path: '/accounting/reports/cash-flow', label: 'Cash Flow', permission: 'cash-flow' },
  ...
  return (
    <div className="w-64 min-h-screen bg-[#1a1a2e] text-white flex flex-col shadow-xl flex-shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-white/10">
        <div className="w-10 h-10 bg-[#1088dd] rounded-xl flex items-center justify-center">
          <Calculator className="w-5 h-5 text-white" />
        </div>
        <div>
          <p className="text-sm font-bold text-white">Accounting Module</p>
      ...
      <div className="px-3 pb-6">
        <div className="p-4 bg-[#1088dd]/10 rounded-xl border border-[#1088dd]/20">
          <HelpCircle className="w-5 h-5 text-[#1088dd] mb-2" />
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-bold text-gray-800 flex items-center gap-2">
              <Calculator className="w-6 h-6 text-[#091746]" />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <Phone className="w-4 h-4 text-[#1088dd]" />
            ...
            <div className="flex items-center gap-2 cursor-pointer hover:bg-gray-100 px-3 py-1.5 rounded-lg transition-all">
              <div className="w-8 h-8 bg-[#091746] rounded-full flex items-center justify-center text-white text-sm font-bold">
                A
              </div>
