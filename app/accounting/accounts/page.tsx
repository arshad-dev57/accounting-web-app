...
function AccountForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingAccount?.id) {
      (onSave as (id: string, data: Partial<ChartOfAccount>) => Promise<void>)(editingAccount.id, formData);
    } else {
      (onSave as (data: Partial<ChartOfAccount>) => Promise<void>)(formData);
    }
  };
