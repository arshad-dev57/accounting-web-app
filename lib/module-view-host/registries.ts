...
export const salesViewHostConfig: ModuleViewHostConfig = {
  ...
  viewLoaders: {
    ...
    '/sales/quotations': loader(() => import('@/sales/quotations/page'), 'QuotationsPage'),
    ...
    '/sales/deliveries/create': loader(() => import('@/sales/deliveries/create/page'), 'default'),
    '/sales/invoices': loader(() => import('@/sales/invoices/page'), 'SalesInvoicesPage'),
    '/sales/invoices/create': loader(() => import('@/sales/invoices/create/page'), 'default'),
    '/sales/sales-payment': loader(() => import('@/sales/sales-payment/page'), 'SalesPaymentsPage'),
    '/sales/sales-payment/create': loader(() => import('@/sales/sales-payment/create/page'), 'default'),
...
export const warehouseViewHostConfig: ModuleViewHostConfig = {
  ...
  viewLoaders: {
    ...
    '/warehouse/transfers': loader(() => import('@/warehouse/transfers/page'), 'WarehouseTransfersPage'),
...
export const purchasesViewHostConfig: ModuleViewHostConfig = {
  ...
  viewLoaders: {
    ...
    '/purchases/requisitions': loader(() => import('@/purchases/requisitions/page'), 'PurchaseRequisitionsPage'),
    ...
    '/purchases/refunds': loader(() => import('@/purchases/refunds/page'), 'PurchaseRefundsPage'),
