...
export const GLOBAL_SEARCH_PAGES: GlobalSearchPage[] = [
  ...
  { path: '/warehouse/reports', label: 'Inventory Reports', group: 'warehouse', module: 'warehouse', permission: 'reports', keywords: ['all reports'] },
  ...
  { path: '/warehouse/orders', label: 'Inventory Orders', group: 'warehouse', module: 'warehouse', keywords: ['pick', 'pack', 'fulfilment'] },
  { path: '/warehouse/returns', label: 'Inventory Returns', group: 'warehouse', module: 'warehouse', keywords: ['returned goods'] },
  { path: '/warehouse/refunds', label: 'Inventory Refunds', group: 'warehouse', module: 'warehouse', keywords: ['money back'] },
  { path: '/warehouse/product-settings', label: 'Product Settings', group: 'warehouse', module: 'warehouse', permission: 'settings', keywords: ['units', 'uom', 'inventory settings'] },
  ...
  { path: '/hr/payroll/dashboard', label: 'Payroll Dashboard', group: 'hr', module: 'hr', keywords: ['payroll overview', 'salary workflow'] },
  { path: '/hr/payroll', label: 'Run Payroll', group: 'hr', module: 'hr', keywords: ['salary', 'wages', 'calculate payroll'] },
  { path: '/hr/payroll/run', label: 'Run Payroll', group: 'hr', module: 'hr', keywords: ['calculate', 'salary build'] },
  { path: '/hr/payroll/salary-structures', label: 'Salary Structures', group: 'hr', module: 'hr', keywords: ['basic', 'allowances', 'statutory'] },
  { path: '/hr/payroll/employee-salary', label: 'Employee Salary', group: 'hr', module: 'hr', keywords: ['package salary', 'employee pay'] },
  { path: '/hr/payroll/periods', label: 'Pay Periods', group: 'hr', module: 'hr', keywords: ['salary month', 'pay period'] },
  { path: '/hr/payroll/review', label: 'Payroll Review', group: 'hr', module: 'hr', keywords: ['approve payroll'] },
  { path: '/hr/payroll/pay-register', label: 'Pay Register', group: 'hr', module: 'hr', keywords: ['salary register', 'payroll register', 'consolidated payroll'] },
  { path: '/hr/payroll/payslips', label: 'Payslips', group: 'hr', module: 'hr', keywords: ['payslip', 'print salary'] },
  { path: '/hr/payroll/payments', label: 'Payroll Payments', group: 'hr', module: 'hr', keywords: ['mark paid', 'disbursement'] },
  { path: '/hr/payroll/history', label: 'Payroll History', group: 'hr', module: 'hr', keywords: ['past payroll', 'register history'] },
  { path: '/hr/payroll/sales', label: 'Sales Payroll / Commission', group: 'hr', module: 'hr', keywords: ['commission', 'incentive', 'sales staff'] },
  { path: '/hr/reports/payroll', label: 'Payroll Reports', group: 'hr', module: 'hr', keywords: ['salary register', 'tax report', 'deduction report'] },
  { path: '/hr/attendance/reports', label: 'Attendance Reports', group: 'hr', module: 'hr', keywords: ['attendance register', 'export'] },
  { path: '/hr/settings/payroll', label: 'Payroll Settings', group: 'hr', module: 'hr', keywords: ['salary policy', 'deduction policy'] },
  { path: '/hr/cost-centers', label: 'Cost Centers', group: 'hr', module: 'hr', keywords: ['cost center', 'allocation'] },
  ...
  { path: '/hr/reports', label: 'HR Reports', group: 'hr', module: 'hr', keywords: ['attendance analytics', 'workforce reports'] },
